    ...
    <div class="row">
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="POST" action="{{url('insert/branch-assigntment')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3">
              ...
              <select class="form-select" id="sales_id" name="sales_id" aria-label="sales id" required>
                <option selected>Open this select sales id</option>
            ...
            <div class="row mb-3">
              ...
              <select class="form-select" id="branch_id" name="branch_id" aria-label="branch id" required>
                <option selected>Open this select branch id</option>
                @foreach($branch as $row)
                  <option value="{{$row->id}}">{{$row->branch_id}}</option>
                @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="date" id="valid_from" name="valid_from" required>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="date" id="valid_to" name="valid_to" required>
            </div>
          </div>
