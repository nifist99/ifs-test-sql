...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <nav class="navbar navbar-example navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid" style="justify-content: start">
          <a class="btn btn-primary btn-sm" href="{{url('create/branch')}}"><i class='bx bx-plus'></i>&nbsp;Tambah {{$name}}</a>
          </div>
      </nav>
    </div>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$key->category}}</td>
                    <td>
                      <a href="{{url('edit/'.Crypt::encryptString($key->id).'/branch')}}" class="btn btn-sm btn-icon btn-warning">
        ...
        function hapus(id){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    location.href="{{url('delete/branch')}}/"+id; 
                    Swal.fire(
                    'Deleted!',
