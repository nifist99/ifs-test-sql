      ...
      <div class="col-xxl">
        <div class="card mb-4">
          <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Silahkan Masukan Data {{$name}}</h5>
            <small class="text-muted float-end">{{Session::get('name')}}</small>
          </div>
          <div class="card-body">
            <form method="POST" action="{{url('insert/sales')}}" enctype="multipart/form-data">
            @csrf
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="sales_id">sales_id</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="sales_id" id="sales_id" placeholder="sales_id" required/>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="sales_name" id="sales_name" placeholder="sales_name" required/>
                </div>
              </div>
